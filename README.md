...
- этапы и доступ к этапам через отдельную таблицу `task_members`;
...
| --- | --- | --- | --- | --- |
| Просмотр доступного проекта и этапов | да | да | да | да |
...
- `task_members` видят только участники этого этапа и owner/admin проекта;
